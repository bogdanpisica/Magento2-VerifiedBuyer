 ...
 */
namespace Thecon\VerifiedBuyer\Model\ResourceModel\Review;
...
class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    ...
    {
        $this->_init(\Thecon\VerifiedBuyer\Model\Review::class, \Thecon\VerifiedBuyer\Model\ResourceModel\Review::class);
    }
    ...
    protected function _initSelect()
    {
        ...
        $this->getSelect()->join(
            ...
            ['detail_id', 'title', 'detail', 'nickname', 'customer_id', 'isValid']
        );
        return $this;
    }
