 ...
 */
namespace Thecon\VerifiedBuyer\Controller\Product;

use Magento\Framework\App\Action\HttpPostActionInterface as HttpPostActionInterface;
use Thecon\VerifiedBuyer\Controller\Product as ProductController;
        ...
        if (($product = $this->initProduct()) && !empty($data)) {
            ...
            if ($validate === true) {
                try {
                    ...
                    $this->helperData->runSqlQuery($review->getId());
